...
// instancia- quando cria uma nova pessoa 
...
class PessoaNova{
    ...
    get nome(){
        return this._nome; //  GET metodo que serve para ler um atributo
    }
    
    set nome(novoNome){  // SET metodo que serve para modificar um atributo
  this._nome = novoNome;
    }
}
