...
//Acessando um elemento na posição Nodelist
console.log(document.body.childNodes[1].childNodes);
 
//Propriedades para acessar o elemento do titulo
...
// selecionando elementos por classes
...
primeiroLink.setAttribute("target", "_black");
...
//getClienteBoundingRect -  retangulo delimitador do conteudo visivel
const produtos1 = produtos[0];
console.log  = (produtos1.getBoundingClientRect());


//css com js, palavras com traço em css vira camelCase em javascript
...
//HTML collection -  fazendo um loo no li e alterando a cor de fundo
